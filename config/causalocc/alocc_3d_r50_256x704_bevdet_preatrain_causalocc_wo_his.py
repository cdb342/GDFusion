...
# ===> bus - IoU = 43.9601
# ===> car - IoU = 52.8945
# ===> construction_vehicle - IoU = 25.2869
# ===> motorcycle - IoU = 28.9332
# ===> pedestrian - IoU = 29.1737
# ===> traffic_cone - IoU = 31.924
# ===> trailer - IoU = 35.5697
# ===> truck - IoU = 39.2801
# ===> driveable_surface - IoU = 81.2594
# ===> other_flat - IoU = 43.1576
# ===> sidewalk - IoU = 52.8085
# ===> terrain - IoU = 55.8537
# ===> manmade - IoU = 46.2597
# ===> vegetation - IoU = 40.635
# ===> free - IoU = 90.0262
# ===> mIoU of 6019 samples: 40.94
# ===> occupied - IoU = 70.6854
# ===> mIoU_D = 35.4464
...
depth2occ_intra_post_norm=True
learnable_pose=True
normconv=True
...
model = dict(
    ...
    depth_net=dict(
        ...
        depth2occ_intra_post_norm=depth2occ_intra_post_norm,
    ),
