...
# ===> bus - IoU = 45.7749
# ===> car - IoU = 56.5453
# ===> construction_vehicle - IoU = 31.9924
# ===> motorcycle - IoU = 34.4993
# ===> pedestrian - IoU = 32.676
# ===> traffic_cone - IoU = 38.1666
# ===> trailer - IoU = 38.3398
# ===> truck - IoU = 43.8678
# ===> driveable_surface - IoU = 85.078
# ===> other_flat - IoU = 50.2548
# ===> sidewalk - IoU = 58.5406
# ===> terrain - IoU = 62.3052
# ===> manmade - IoU = 53.485
# ===> vegetation - IoU = 47.5724
# ===> free - IoU = 91.9917
# ===> mIoU of 6019 samples: 45.87
# ===> occupied - IoU = 75.8948
# ===> mIoU_D = 39.5476
