...
train_pipeline = [
    ...
    dict(type='PointToMultiViewDepth_FBBEV', downsample=1, grid_config=grid_config),
    ...
    dict(
        type='Collect3D', keys=['img_inputs', 'gt_bboxes_3d', 'gt_labels_3d',  'gt_occupancy', 'gt_depth','aux_cam_params','adj_aux_cam_params'
                               ])
]
...
test_pipeline = [
    dict(
        ...
        tta=False,
        transforms=[
            dict(type='PrepareImageInputs_FBBEV', data_config=data_config,depth_his_fusion_post=depth_his_fusion_post),
            dict(
                type='LoadAnnotationsBEVDepth_FBBEV',
                bda_aug_conf=bda_aug_conf,
                classes=class_names,
