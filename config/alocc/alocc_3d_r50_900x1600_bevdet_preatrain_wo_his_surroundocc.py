...
# ===> bus - IoU = 28.0158
# ===> car - IoU = 32.8589
# ===> construction_vehicle - IoU = 16.9957
# ===> motorcycle - IoU = 20.1966
# ===> pedestrian - IoU = 17.1797
# ===> traffic_cone - IoU = 16.8513
# ===> trailer - IoU = 15.4026
# ===> truck - IoU = 25.4544
# ===> driveable_surface - IoU = 41.7986
# ===> other_flat - IoU = 26.6897
# ===> sidewalk - IoU = 28.256
# ===> terrain - IoU = 26.9679
# ===> manmade - IoU = 18.5682
# ===> vegetation - IoU = 27.0348
# ===> free - IoU = 93.9452
# ===> mIoU of 6019 samples: 23.96
# ===> mIoU_D = 21.6868
# ===> occupied - IoU = 34.7253
...
train_pipeline = [
    ...
    dict(type='LoadOccupancy', ignore_nonvisible=True, fix_void=fix_void, occupancy_path=occupancy_path,gts_surroundocc=gts_surroundocc),
...
test_pipeline = [
    dict(
        ...
        tta=False,
        transforms=[
            dict(type='PrepareImageInputs', data_config=data_config, sequential=True,gts_surroundocc=gts_surroundocc),
            dict(
                type='LoadAnnotationsBEVDepth',
                bda_aug_conf=bda_aug_conf,
                classes=class_names,
