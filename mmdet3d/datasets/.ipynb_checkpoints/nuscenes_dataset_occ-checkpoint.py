...
from .occ_metrics_bevdet import Metric_mIoU, Metric_FScore
...
class NuScenesDatasetOccpancy(NuScenesDatasetBEVDet):
    ...
    def evaluate(self, occ_results, runner=None, show_dir=None, **eval_kwargs):
        if 'use_image_mask' not in eval_kwargs:
            use_image_mask=True
        else:
            use_image_mask=eval_kwargs['use_image_mask']
        ...
        print('\nStarting Evaluation...')
        # import pdb;pdb.set_trace()
        print(len(occ_results),len(self.data_infos))
