...
# SOLOFusion
    ...
    def load_annotations(self, ann_file):
        ...
        #######################
        if self.load_partial_data is not None:
            scene_tokens=[data['scene_token'] for data in data_infos]
            scene_tokens_unique=list(set(scene_tokens))
            random.shuffle(scene_tokens_unique)
            sampled_scene_tokens_unique=scene_tokens_unique[:int(self.load_partial_data*len(scene_tokens_unique))]
            sample_scenes_data=[data for data in data_infos if data['scene_token'] in sampled_scene_tokens_unique]
            data_infos=sample_scenes_data
        ###########################
