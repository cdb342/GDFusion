...
class LoadSemKittiAnnotation():
    ...
    def __call__(self, results):
        ...
        results['img_inputs'] = (imgs, rots, trans, intrins, post_rots, post_trans, bda_rot[:3,:3], sensor2sensors)
        # print(bda_rot.shape,111111111111111)
        # import pdb;pdb.set_trace()

        results['gt_occupancy'] = gt_occ.long()
