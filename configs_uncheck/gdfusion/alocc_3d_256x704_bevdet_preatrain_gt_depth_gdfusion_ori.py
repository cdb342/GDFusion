...
# }      
depth_categories = 88
# depth_categories = (grid_config['depth'][1]-grid_config['depth'][0])//grid_config['depth'][2]
...
ttt_v22_norm2=True
use_ttt_func=True
save_grad_with_lr=True

ttt_wo_res=True
ttt_no_per_norm=True
ttt_wo_mid_norm=False
ttt_wo_post_norm_project=True
ttt_w_pre_detach=False
ttt_no_learned_lr=True
ttt_mat_k=False
ttt_wo_his_grad=False
ttt_sup_w_his=False
ttt_his_decay=False
ttt_his_decay_rate=0.5
use_ttt_after_his=True
use_ttt_pre_his=False
...
ttt_mlp=False
ttt_mid_channel=numC_Trans*2
ttt_base_eta=1.
ttt_on_ln=True


depth2occ_direct_return_occ=True
depth_denoise_in_depth_net=True
depth_his_fusion_post=True
depth_his_fusion_after_sup=True
softmax_after_his_fusion=False
depth_conv_head_split=True
conv_fusion=False
depth_his_head_divide=True
per_pixel_weight=True
depth_his_sup_w_his=False
gate_net_with_his=True
gate_net_mlp=True
depth_his_post_sigmoid=False
...
use_gt_depth=False
depth_gt=True
depth_his_fusion_post_with_gt=True
...
model = dict(
    ...
    downsample=16,
    not_use_maskformerocc_head=not_use_maskformerocc_head,
    ...
    do_his_recurrence=do_his_recurrence,
        first_frame_no_fuse=first_frame_no_fuse,
...
vox_his_time_emb_fixed=vox_his_time_emb_fixed,
        ...
        ttt_v222=ttt_v222,
        ttt_v2222=ttt_v2222,
        ttt_v22_norm2=ttt_v22_norm2,
        use_ttt_func=use_ttt_func,
        ttt_wo_res=ttt_wo_res,
        ttt_no_per_norm=ttt_no_per_norm,
        ttt_wo_mid_norm=ttt_wo_mid_norm,
        ttt_wo_post_norm_project=ttt_wo_post_norm_project,
        ttt_w_pre_detach=ttt_w_pre_detach,
        ttt_no_learned_lr=ttt_no_learned_lr,
        ttt_mat_k=ttt_mat_k,
        ttt_wo_his_grad=ttt_wo_his_grad,
        ttt_sup_w_his=ttt_sup_w_his,
        ttt_his_decay=ttt_his_decay,
                 ttt_his_decay_rate=ttt_his_decay_rate,
                 use_ttt_pre_his=use_ttt_pre_his,
                 use_ttt_after_his=use_ttt_after_his,
                 ttt_mlp=ttt_mlp,
                 ttt_mid_channel=ttt_mid_channel,
                 ttt_base_eta=ttt_base_eta,
                 ttt_on_ln=ttt_on_ln,
        save_grad_with_lr=save_grad_with_lr,
        
        
depth2occ_direct_return_occ=depth2occ_direct_return_occ,
depth_denoise_in_depth_net=depth_denoise_in_depth_net,
depth_his_fusion_post=depth_his_fusion_post,
    depth_his_fusion_after_sup=depth_his_fusion_after_sup,
    

stream_offset=stream_offset,
    use_offset_his=use_offset_his,
    offset_base_lr=offset_base_lr,
    ...
    depth_net=dict(
        ...
        depth_his_fusion_post=depth_his_fusion_post,
        depth_his_fusion_after_sup=depth_his_fusion_after_sup,
        softmax_after_his_fusion=softmax_after_his_fusion,
        depth_conv_head_split=depth_conv_head_split,
        conv_fusion=conv_fusion,
        depth_his_head_divide=depth_his_head_divide,
        per_pixel_weight=per_pixel_weight,
        depth_his_sup_w_his=depth_his_sup_w_his,
        gate_net_with_his=gate_net_with_his,
        gate_net_mlp=gate_net_mlp,
        depth_his_post_sigmoid=depth_his_post_sigmoid,

        depth_his_fusion_post_with_gt=depth_his_fusion_post_with_gt,
        depth_gt=depth_gt,
    ),
    ...
    #     in_channels=[voxel_out_channels] * len(voxel_out_indices),
    #     out_channel=num_cls,
...
train_pipeline = [
    ...
    dict(type='LoadOccupancy', ignore_nonvisible=use_visible_mask, fix_void=fix_void, occupancy_path=occupancy_path),
...
test_pipeline = [
    dict(
        ...
        tta=False,
        transforms=[
            dict(type='PrepareImageInputs_FBBEV', data_config=data_config, sequential=True,depth_his_fusion_post=depth_his_fusion_post),
            dict(
                type='LoadAnnotationsBEVDepth_FBBEV',
                bda_aug_conf=bda_aug_conf,
                classes=class_names,
            ...
            dict(
                ...
                use_dim=5,
                file_client_args=file_client_args),
            dict(type='PointToMultiViewDepth_FBBEV', downsample=1, grid_config=grid_config,fix_void=fix_void),
            dict(type='LoadOccupancy',  occupancy_path=occupancy_path),
            dict(
                type='DefaultFormatBundle3D',
                class_names=class_names,
                with_label=False),
            dict(type='Collect3D', keys=['points', 'img_inputs',  'gt_occupancy', 'gt_depth', 'visible_mask','aux_cam_params','adj_aux_cam_params'])
            ]
        )
]
...
custom_hooks = [
    dict(
        ...
        # resume='work_dirs/fb_occ/fbocc-r50-cbgs_depth_16f_16x4_20e-LSSOnly_swin_base_stereo_his16/iter_32022_ema.pth',
    ),
    dict(
...
# resume_from='work_dirs/fb_occ/fbocc-r50-cbgs_depth_16f_16x4_20e-LSSOnly_small_gai_epoch_lr2_gai_bev_ecoder_ce_loss_only_depth_005_gai_occ_head_stereo_samll_depth_net_pre_net_bevdet_pretrain/epoch_20.pth'