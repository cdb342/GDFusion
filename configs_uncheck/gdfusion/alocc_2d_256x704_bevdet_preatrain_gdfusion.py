...
vox_his_time_emb_fixed=vox_his_time_emb_fixed,
    ...
    geometry_his_fusion_after_sup=geometry_his_fusion_after_sup,
    

    motion_his=motion_his,
...
test_pipeline = [
    dict(
        ...
        tta=False,
        transforms=[
            dict(type='PrepareImageInputs_FBBEV', data_config=data_config, sequential=True,geometry_his_fusion=geometry_his_fusion),
            dict(
                type='LoadAnnotationsBEVDepth_FBBEV',
                bda_aug_conf=bda_aug_conf,
                classes=class_names,
