...
custom_hooks = [
    dict(
        ...
        # resume='ww/automl-parkingmultitask-train-test9999999999-91jdr/alocc/work_dir/configs/timeocc/adaocc_depth1_depth_denoise6_wo_df_lift_offset_depth2hidden_gt_depth.py/iter_32020_ema.pth',
    ),
    dict(
...
# resume_from='ww/automl-parkingmultitask-train-test9999999999-91jdr/alocc/work_dir/configs/timeocc/adaocc_depth1_depth_denoise6_wo_df_lift_offset_depth2hidden_gt_depth.py/iter_32020.pth'