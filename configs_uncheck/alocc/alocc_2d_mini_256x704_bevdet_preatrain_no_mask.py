...
bev_2d_out_channels=128
reserve_stereo=True
depth_denoise=True
pre_gen_his_grid=True
depth2occ_hidden=False
camera_visible_mask=False
model = dict(
    type='ALOCC',
...
train_pipeline = [
    ...
    dict(type='LoadOccupancy', ignore_nonvisible=camera_visible_mask, fix_void=fix_void, occupancy_path=occupancy_path),
...
test_pipeline = [
    dict(
        ...
        tta=False,
        transforms=[
            dict(type='PrepareImageInputs_FBBEV', data_config=data_config, sequential=depth_stereo,reserve_stereo=reserve_stereo),
            dict(
                type='LoadAnnotationsBEVDepth_FBBEV',
                bda_aug_conf=bda_aug_conf,
                classes=class_names,
            ...
            dict(
                ...
                with_label=False),
            dict(type='Collect3D', keys=['img_inputs',  'aux_cam_params'])
            ]
        )
]
...
custom_hooks = [
    dict(
        ...
        # resume='ww/configs/timeocc/bevdet_pretrain_depth2occ_deform_lift_with_prototype_sup_sem_only_weight01_depth2occ_depth_ce_loss_deform_lift_offsets1_mf_head_wo_assign_length22_use_embed2_channel4_dim48_his16_2d_bakbone_dim40/iter_64040_ema.pth',
    ),
    dict(
...
# resume_from='ww/configs/timeocc/bevdet_pretrain_depth2occ_deform_lift_with_prototype_sup_sem_only_weight01_depth2occ_depth_ce_loss_deform_lift_offsets1_mf_head_wo_assign_length22_use_embed2_channel4_dim48_his16_2d_bakbone_dim40/iter_64040.pth'